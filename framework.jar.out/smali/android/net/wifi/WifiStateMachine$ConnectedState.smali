...
.method public enter()V
    ...
    invoke-static {v0, v1}, Landroid/net/wifi/WifiStateMachine;->access$14602(Landroid/net/wifi/WifiStateMachine;Z)Z

    .line 5666
    iget-object v0, p0, Landroid/net/wifi/WifiStateMachine$ConnectedState;->this$0:Landroid/net/wifi/WifiStateMachine;

    #getter for: Landroid/net/wifi/WifiStateMachine;->mVzwWifiStatusFeature:Z
    invoke-static {v0}, Landroid/net/wifi/WifiStateMachine;->access$14700(Landroid/net/wifi/WifiStateMachine;)Z
    ...
    invoke-static {v0}, Landroid/net/wifi/WifiStateMachine;->access$14800(Landroid/net/wifi/WifiStateMachine;)I
    ...
    invoke-static {v0, v2}, Landroid/net/wifi/WifiStateMachine;->access$14802(Landroid/net/wifi/WifiStateMachine;I)I
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v6, v4}, Landroid/net/wifi/WifiStateMachine;->access$13400(Landroid/net/wifi/WifiStateMachine;Landroid/net/DhcpInfoInternal;)V
    ...
    :cond_6
    invoke-static {v6}, Landroid/net/wifi/WifiNative;->setRoamingDisabled(I)V
