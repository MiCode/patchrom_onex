...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/hardware/SensorManager$SensorHandler;,
...
.field private static final DISABLE_DELAY:I = 0x3e8
...
.field private static final MSG_DISABLE_SENSOR:I = 0x0
...
.field private static final bADD_DISABLE_DELAY:Z

.field private static iHandleGSensor:I
...
# instance fields
.field private mHandler2:Landroid/hardware/SensorManager$SensorHandler;
...
.method static constructor <clinit>()V
    ...
    .line 377
    sput v1, Landroid/hardware/SensorManager;->sQueue:I
    ...
    sput v0, Landroid/hardware/SensorManager;->iHandleGSensor:I
...
.method public constructor <init>(Landroid/os/Looper;)V
    ...
    iput-object v4, p0, Landroid/hardware/SensorManager;->mLegacyListenersMap:Ljava/util/HashMap;
    ...
    new-instance v6, Landroid/hardware/SensorManager$1;

    invoke-direct {v6, p0}, Landroid/hardware/SensorManager$1;-><init>(Landroid/hardware/SensorManager;)V

    invoke-interface {v4, v6}, Landroid/view/IWindowManager;->watchRotation(Landroid/view/IRotationWatcher;)I
    ...
    sget-object v6, Landroid/hardware/SensorManager;->sFullSensorsList:Ljava/util/ArrayList;
    ...
    invoke-direct {v4, p0, v6}, Landroid/hardware/SensorManager$SensorEventPool;-><init>(Landroid/hardware/SensorManager;I)V
    ...
    .line 701
    new-instance v4, Landroid/hardware/SensorManager$SensorHandler;

    invoke-virtual {v3}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v5

    invoke-direct {v4, p0, v5}, Landroid/hardware/SensorManager$SensorHandler;-><init>(Landroid/hardware/SensorManager;Landroid/os/Looper;)V

    iput-object v4, p0, Landroid/hardware/SensorManager;->mHandler2:Landroid/hardware/SensorManager$SensorHandler;
...
.method static synthetic access$300()Landroid/hardware/SensorManager$SensorThread;
    .locals 1

    .prologue
    .line 89
    sget-object v0, Landroid/hardware/SensorManager;->sSensorThread:Landroid/hardware/SensorManager$SensorThread;
...
.method private disableSensorLocked(Landroid/hardware/Sensor;)Z
    ...
    const-string v7, "[Sensor] disableSensorLocked: "
    ...
    const-string v7, ",sQueue="

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    sget v7, Landroid/hardware/SensorManager;->sQueue:I
...
.method private enableSensorLocked(Landroid/hardware/Sensor;I)Z
    ...
    const-string v7, "[Sensor] enableSensorLocked: "
    ...
    invoke-virtual {v1}, Landroid/hardware/SensorManager$ListenerDelegate;->getSensors()Ljava/util/List;
