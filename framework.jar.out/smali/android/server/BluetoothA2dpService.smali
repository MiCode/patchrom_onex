...
.field private static final mMetadataMap:Ljava/util/HashMap;
...
.field private static final mSettingValuesMap:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.field private static final mSettingsMap:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.field private static final mStatusMap:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 77
    invoke-static {}, Landroid/server/BluetoothA2dpService;->createStatusMap()Ljava/util/HashMap;

    move-result-object v0

    sput-object v0, Landroid/server/BluetoothA2dpService;->mStatusMap:Ljava/util/HashMap;

    .line 78
    invoke-static {}, Landroid/server/BluetoothA2dpService;->createSettingsMap()Ljava/util/HashMap;

    move-result-object v0

    sput-object v0, Landroid/server/BluetoothA2dpService;->mSettingsMap:Ljava/util/HashMap;

    .line 79
    invoke-static {}, Landroid/server/BluetoothA2dpService;->createSettingValuesMap()Ljava/util/HashMap;

    move-result-object v0

    sput-object v0, Landroid/server/BluetoothA2dpService;->mSettingValuesMap:Ljava/util/HashMap;

    .line 80
    invoke-static {}, Landroid/server/BluetoothA2dpService;->createMetadataMap()Ljava/util/HashMap;

    move-result-object v0

    sput-object v0, Landroid/server/BluetoothA2dpService;->mMetadataMap:Ljava/util/HashMap;
...
.method public constructor <init>(Landroid/content/Context;Landroid/server/BluetoothService;)V
    ...
    iput-object v0, p0, Landroid/server/BluetoothA2dpService;->delayResumeDevices:[Ljava/lang/String;
    ...
    iput-object v0, p0, Landroid/server/BluetoothA2dpService;->delayResumeFamiliarDevices:[Ljava/lang/String;
    ...
    .line 264
    new-instance v0, Landroid/server/BluetoothA2dpService$3;

    invoke-direct {v0, p0}, Landroid/server/BluetoothA2dpService$3;-><init>(Landroid/server/BluetoothA2dpService;)V

    iput-object v0, p0, Landroid/server/BluetoothA2dpService;->mAvrcpReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, Landroid/server/BluetoothA2dpService;->mAvrcpIntentFilter:Landroid/content/IntentFilter;

    .line 421
    iget-object v0, p0, Landroid/server/BluetoothA2dpService;->mContext:Landroid/content/Context;

    iget-object v1, p0, Landroid/server/BluetoothA2dpService;->mAvrcpReceiver:Landroid/content/BroadcastReceiver;

    iget-object v2, p0, Landroid/server/BluetoothA2dpService;->mAvrcpIntentFilter:Landroid/content/IntentFilter;
...
.method private avrcpRegisterMediaPlayer(Landroid/os/Bundle;Landroid/os/Bundle;)V
    .locals 5
    .parameter "metadata"
    .parameter "settings"
    ...
    .prologue
    .line 368
    invoke-direct {p0, p1}, Landroid/server/BluetoothA2dpService;->parseMetadata(Landroid/os/Bundle;)[Ljava/lang/String;

    move-result-object v0

    .line 369
    .local v0, parsedMetadata:[Ljava/lang/String;
    invoke-direct {p0, p2}, Landroid/server/BluetoothA2dpService;->parseMediaPlayerSettings(Landroid/os/Bundle;)[Ljava/lang/String;
...
.method private static createMetadataMap()Ljava/util/HashMap;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method private static createSettingValuesMap()Ljava/util/HashMap;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method private static createSettingsMap()Ljava/util/HashMap;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method private static createStatusMap()Ljava/util/HashMap;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method private parseMediaPlayerSettings(Landroid/os/Bundle;)[Ljava/lang/String;
    .locals 10
    .parameter "settings"
    ...
    sget-object v7, Landroid/server/BluetoothA2dpService;->mSettingsMap:Ljava/util/HashMap;
    ...
    const-string v9, "Ignoring unknown setting "
    ...
    .line 355
    .local v6, value:I
    sget-object v7, Landroid/server/BluetoothA2dpService;->mSettingValuesMap:Ljava/util/HashMap;
    ...
    const-string v9, "Ignoring setting "
    ...
    const-string v9, " because of unkown value "
...
.method private parseMetadata(Landroid/os/Bundle;)[Ljava/lang/String;
    .locals 7
    .parameter "metadata"
    ...
    .line 323
    .local v3, key:Ljava/lang/String;
    sget-object v6, Landroid/server/BluetoothA2dpService;->mMetadataMap:Ljava/util/HashMap;
