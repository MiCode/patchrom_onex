...
.method constructor <init>(Lcom/android/server/BatteryService;Ljava/lang/String;Ljava/lang/StringBuilder;Ljava/io/File;Landroid/os/DropBoxManager;J)V
    ...
    iput-object p3, p0, Lcom/android/server/BatteryService$6;->val$sb:Ljava/lang/StringBuilder;

    iput-object p4, p0, Lcom/android/server/BatteryService$6;->val$logFile:Ljava/io/File;

    iput-object p5, p0, Lcom/android/server/BatteryService$6;->val$dbox:Landroid/os/DropBoxManager;

    iput-wide p6, p0, Lcom/android/server/BatteryService$6;->val$entryTime:J
...
.method public run()V
    ...
    :try_start_1
    iget-object v0, p0, Lcom/android/server/BatteryService$6;->val$sb:Ljava/lang/StringBuilder;
    ...
    .line 658
    iget-object v0, p0, Lcom/android/server/BatteryService$6;->val$logFile:Ljava/io/File;
    ...
    iget-object v1, p0, Lcom/android/server/BatteryService$6;->val$logFile:Ljava/io/File;
    ...
    .line 663
    :cond_0
    iget-object v0, p0, Lcom/android/server/BatteryService$6;->val$dbox:Landroid/os/DropBoxManager;

    const-string v1, "HTC_BATT_LOG"

    const/4 v3, 0x2

    iget-wide v4, p0, Lcom/android/server/BatteryService$6;->val$entryTime:J
    ...
    iget-wide v3, p0, Lcom/android/server/BatteryService$6;->val$entryTime:J
